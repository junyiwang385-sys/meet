    ...
    def request(
        ...
        *,
        ...
        try:
            ...
            raw_http = response_handle.read().decode("utf-8", "replace")
        ...
        try:
            ...
            emit_request_failed("invalid_response", str(exc))
            raise
    ...
    def close(self) -> None:
        ...
        atomic_write_json(
            self.out_dir / "server_status.json",
            {
                ...
                "response_parse_success_count": self.response_parse_success_count,
